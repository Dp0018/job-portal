...
public class ExceptionControllerAdvice {
    ...
    @ExceptionHandler(JobPortalExceeption.class)
    public ResponseEntity<ErrorInfo> generalException(JobPortalExceeption exception) {
    ...
    public ResponseEntity<ErrorInfo> validatoExceptionHandler(Exception exception) {
        String msg = "";
